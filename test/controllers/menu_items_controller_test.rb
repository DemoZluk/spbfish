...
class MenuItemsControllerTest < ActionController::TestCase
  ...
  test "should create menu_item" do
    assert_difference('MenuItem.count') do
      post :create, menu_item: { parent_id: @menu_item.parent_id, permalink: @menu_item.permalink, published: @menu_item.published, title: @menu_item.title }
    end
  ...
  test "should update menu_item" do
    patch :update, id: @menu_item, menu_item: { parent_id: @menu_item.parent_id, permalink: @menu_item.permalink, published: @menu_item.published, title: @menu_item.title }
    assert_redirected_to menu_item_path(assigns(:menu_item))
  end
